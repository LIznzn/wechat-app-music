...
Page({
  ...
  loadMusicList(id) {
    api.getMusicList({
      ...
      success: resp => {
        var musicList = resp.data.playlist.tracks;
        this.setData({
          songListArr: musicList,
          playCount: resp.data.playlist.playCount,
          listName: resp.data.playlist.name,
          coverImgUrl: resp.data.playlist.coverImgUrl,
          creatorName: resp.data.playlist.creator.nickname,
          usericon: resp.data.playlist.creator.avatarUrl,
          flag: true
        });
